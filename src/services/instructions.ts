import { AnimeProcessingInstructions } from '../types/index.js';

export class InstructionsService {
  private static instance: InstructionsService;
  ...
  public getAnimeProcessingInstructions(): AnimeProcessingInstructions {
    return {
      steps: [
  ...
  public getProcessOverview(): string {
...
4. **Ajout des épisodes en tant que commentaires**
  ...
  public getDetailedSteps(): string {
...
- Répétez pour tous les épisodes en incrémentant le numéro d'épisode`;
  ...
  public getPracticalTips(): string {
...
5. **Vérifications importantes**
  ...
  public getComprehensiveExample(): string {
